...
bins_list = np.linspace(-400, 400, 17)
print(bins_list)
ax1.hist(dSOC_models.values.flatten(),bins=bins_list, density =True, alpha=0.25,label = 'RF-$\Delta$SOC',edgecolor='black')
xmin, xmax = plt.xlim()
...
fig.savefig('./figures/FIG_histogram_cmip56_delta_soc_test2.png',bbox_inches='tight',dpi=300)
